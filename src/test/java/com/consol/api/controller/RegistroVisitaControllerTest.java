...
public class RegistroVisitaControllerTest {
    ...
    class GetRegistrosVisitas {
        ...
        void deveRetornar200EListaDeRegistrosDeVisitas() throws Exception {
            Donatario donatario1 = Donatario.builder()
                    .id(1)
                    .dataCadastro(LocalDate.now())
                    .nome("Donatário 1")
                    .rg("123456")
            ...
            Donatario donatario2 = Donatario.builder()
                    .id(2)
                    .dataCadastro(LocalDate.now())
                    .nome("Donatário 2")
                    .rg("654321")
            ...
            List<RegistroVisita> registros = List.of(
                    RegistroVisita.builder()
                            .id(1)
                            .donatario(donatario1)
                            .dataVisita(LocalDate.now())
                            .descricao("Descrição 1")
                            .build(),
                    RegistroVisita.builder()
                            .id(2)
                            .donatario(donatario2)
                            .dataVisita(LocalDate.now())
    ...
    class GetRegistrosVisitasPorDonatario {
